    ...
    return (
        <View className="flex-1 bg-white p-5">
            ...
            <Text className="text-gray-500 mt-3 text-center">
                {formatVNTime(lotData?.startTime)} - {formatVNTime(lotData?.expectedEndTime)}
            </Text>
            ...
            <View className="mt-10">
                <Text className="text-gray-600">Deposit Amount: {formatCurrency(lotData?.depositAmount)}</Text>
                <Text className="text-gray-600">Bid increment: {formatCurrency(lotData?.priceStep)}</Text>
                <Text className="text-gray-600">Start bid: {formatCurrency(lotData?.startingPrice)}</Text>
                <Text className="text-gray-600">Price buy now: {formatCurrency(lotData?.buyNowPrice)}</Text>
            </View>

            <View className="mt-16">
                <Text className="text-orange-500 text-2xl font-semibold">Balance of wallet: {formatCurrency(balance)}</Text>
            </View>
            ...
            <View className="flex-1 justify-end pb-5">
                ...
                >
                    <View
                        className={`w-5 h-5 rounded-md border ${isChecked ? "bg-orange-500 border-orange-500" : "border-gray-400"
                    ...
                    <Text className="text-gray-600 ml-3">
                        ...
                        <Text className="text-black font-semibold">terms and conditions</Text> and{" "}
                        <Text className="text-black font-semibold">privacy policy</Text>.
                    </Text>
                </TouchableOpacity>

                <TouchableOpacity
                    className={`p-3 rounded-lg ${isChecked ? "bg-orange-500" : "bg-gray-300"
                        }`}
                    disabled={!isChecked}
